...
initDatePicker : function(){
    if($.datepicker.regional[projetk.getLocale(4)] != undefined ){
        $.datepicker.setDefaults( $.datepicker.regional[projetk.getLocale(4)] );
    }else if($.datepicker.regional[projetk.getLocale(2)] != undefined){
        $.datepicker.setDefaults( $.datepicker.regional[projetk.getLocale(2) ] );
    }else{
        $.datepicker.setDefaults( $.datepicker.regional['']);
    }

    $('.projetKDatePicker').each(function(){
